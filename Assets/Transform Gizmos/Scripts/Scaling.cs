...
namespace TransformGizmos
{
    public class Scaling : MonoBehaviour
    {
        ...
        float scale;
        private GameObject m_targetObject_last;
        ...
        private void OnEnable()
        {
            ...
            {
                m_targetObject_last = m_targetObject;
        ...
        {
            if (m_targetObject_last != null)
            {
                if (m_targetObject_last.GetComponent<Collider>() != null)
                {
                    m_targetObject_last.GetComponent<Collider>().enabled = true;
                }
            }
